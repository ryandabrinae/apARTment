...
ActiveRecord::Schema.define(version: 20170330015949) do
  ...
  create_table "rooms_arts", force: :cascade do |t|
    t.integer  "room_id"
    t.integer  "art_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["art_id"], name: "index_rooms_arts_on_art_id", using: :btree
    t.index ["room_id"], name: "index_rooms_arts_on_room_id", using: :btree
  end
