...
ActiveRecord::Schema.define(version: 20170331142627) do
  ...
  create_table "arts_rooms", force: :cascade do |t|
    t.integer  "room_id"
    t.integer  "art_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["art_id"], name: "index_arts_rooms_on_art_id", using: :btree
    t.index ["room_id"], name: "index_arts_rooms_on_room_id", using: :btree
  end
